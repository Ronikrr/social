        ...
        <section className='relative py-5 paperpaln' >
            ...
            <div className="container flex justify-center mx-auto ">
                <div className="pt-[18px] md:pb-[54px] px-0 flex flex-wrap w-full lg:w-[1140px]">
                    <Link to='/contact' className="w-full p-3 h-[550px]lg:h-[700px]  md:w-4/12">
                    ...
                    <Link to='/career' className="w-full p-3 h-[550px] lg:h-[700px] md:w-4/12">
                    ...
                    <Link to='' className="w-full h-[550px] lg:h-[700px] p-3 md:w-4/12">
