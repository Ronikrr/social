...
const Havealook = () => {
    const [images] = useState([img, img2, img4, img1, img3, img5, img6, img7]);
    const [scrollSpeed, setScrollSpeed] = useState(50); // Adjust speed dynamically if needed

    useEffect(() => {
        const handleResize = () => {
            if (window.innerWidth < 768) {
                setScrollSpeed(50); // Slower speed on smaller screens
            } else {
                setScrollSpeed(50); // Default speed    
            }
        };
