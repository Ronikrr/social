        ...
        <section className="banner relative  pt-[50px] pb-[50px] h-full lg:pt-[80px] lg:pb-[50px]  w-full ">
            ...
            <div className="container mx-auto">
                ...
                <div className="flex flex-wrap items-center justify-center w-full ">
                    {data.map((data, index) => {
                        return (
                            <div className="w-full hover:bg-[#ef4523] transition duration-300 hover:text-white hover:shadow-lg hover:shadow-gray-500  py-[25px] text-center my-[20px] me-0 lg:me-[20px] rounded-[20px] h-[150px] space-y-[10px] xl:w-[514px] border border-black " key={index}>
